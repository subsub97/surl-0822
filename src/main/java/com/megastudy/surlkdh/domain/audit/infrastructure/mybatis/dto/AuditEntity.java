...
public class AuditEntity {
	...
	@Builder
	private AuditEntity(String action, Long auditId, String actorType, Long actorId, String resourceType,
		Long resourceId, Boolean success, String errorMessage, String role) {
		this.action = action;
	...
	public static AuditEntity from(Audit audit) {
		return AuditEntity.builder()
			...
			.errorMessage(audit.getErrorMessage() == null ? null :
				audit.getErrorMessage().substring(0, Math.min(audit.getErrorMessage().length(), 255)))
